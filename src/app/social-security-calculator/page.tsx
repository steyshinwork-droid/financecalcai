...
export const metadata: Metadata = {
  title: "Social Security Calculator — Estimate Your Benefits | FinanceCalcAI",
  description:
      ...
      <section className="mt-16 space-y-8">
        <div>
          ...
          <p className="text-gray-600">
            ...
            progressive formula using "bend points" — in 2025, you receive 90%
            ...
            Insurance Amount) — your benefit at Full Retirement Age (67).
          </p>
        </div>
        <div>
          <h2 className="mb-3 text-2xl font-bold text-gray-900">
          ...
          <p className="text-gray-600">
            ...
            There's no universally right answer — early claiming is rational if
        ...
        <div>
          ...
          <p className="text-gray-600">
            ...
            higher earner's benefit especially valuable — it effectively
        ...
        items={[
          {
            ...
            answer:
              "Full Retirement Age is 67 for anyone born in 1960 or later. For those born between 1943–1954, FRA was 66. For 1955–1959, it gradually increased from 66 to 67. At FRA, you receive 100% of your PIA (Primary Insurance Amount) with no reduction.",
          },
          {
            question: "What happens if I claim Social Security at 62?",
            answer:
              "Claiming at 62 (the earliest possible age) permanently reduces your benefit by about 30% compared to waiting until 67. The reduction is 5/9 of 1% per month for the first 36 months early, and 5/12 of 1% for each additional month. This reduction is permanent — it doesn't go away when you reach FRA.",
          },
          {
            question: "Is it worth waiting until 70 to claim Social Security?",
            answer:
              "Delaying past Full Retirement Age increases your benefit by 8% per year (0.67% per month) until age 70. This means waiting from 67 to 70 boosts your benefit by 24%. The breakeven point vs. claiming at 67 is typically around age 82–83. If you expect to live into your mid-80s or beyond, delaying to 70 almost always pays off — especially for the higher earner in a couple due to survivor benefit implications.",
          },
          {
            question: "How does working affect my Social Security benefits?",
            answer:
              "If you claim Social Security before Full Retirement Age and still work, your benefits may be temporarily reduced if your earnings exceed the annual limit ($22,320 in 2025). Once you reach FRA, there's no earnings limit. Also, Social Security uses your 35 highest-earning years — continuing to work and replacing low-income years can increase your benefit even after you start collecting.",
          },
          {
            question: "Are Social Security benefits taxable?",
            answer:
              "Up to 85% of Social Security benefits can be subject to federal income tax, depending on your 'combined income' (AGI + nontaxable interest + half of SS benefits). If combined income is below $25,000 (single) or $32,000 (married), benefits are not taxed. Between $25,000–$34,000 (single), up to 50% is taxable. Above $34,000 (single), up to 85% is taxable. Some states also tax Social Security benefits.",
          },
        ]}
      />
          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Delaying to 70 increases your benefit by 24% vs. claiming at 67. The breakeven point is around age 82–83. It pays off for those in good health or who want to maximize a spouse's survivor benefit.",
                },
              },
            ],
          }),
