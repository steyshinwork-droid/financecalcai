...
export const metadata: Metadata = {
  title: "FIRE Calculator — When Can You Retire Early? | FinanceCalcAI",
  description:
    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Find your FIRE number — the portfolio size you need to retire early.
      ...
      <section className="mt-16 space-y-8">
        <div>
          ...
          <p className="text-gray-600">
            ...
            movement built around saving and investing aggressively — typically
            50–70% of income — so you can leave traditional employment decades
        ...
        <div>
          ...
          <p className="text-gray-600">
            ...
            Expenses × 25 = FIRE Number. So if you plan to spend $40,000/year
        ...
        <div>
          ...
          <p className="text-gray-600">
            ...
            portfolio of $1,000,000 or less. Regular FIRE targets $50,000–
            $80,000/year spending with a $1.25M–$2M portfolio. Fat FIRE targets
      ...
      <FaqSection items={[
        { question: "What is the FIRE number?", answer: "Your FIRE number is the total portfolio size you need to retire and live off investment returns indefinitely. It's calculated as: Annual Expenses ÷ Safe Withdrawal Rate. At the standard 4% withdrawal rate, this is Annual Expenses × 25. If you plan to spend $50,000/year, your FIRE number is $1,250,000." },
        { question: "Is the 4% rule still valid?", answer: "The 4% rule was based on 30-year retirement horizons. For early retirees facing 40–50 year retirements, many financial planners recommend 3.5% or even 3.3% to account for longer time horizons and lower future expected returns. At 3.5%, your FIRE number becomes Annual Expenses × 28.6. The extra safety margin is meaningful over long retirements." },
        { question: "How much should I save each month for FIRE?", answer: "Your savings rate is the most important factor. People who reach FIRE early typically save 40–70% of their income. At a 50% savings rate (earning $80,000, saving $40,000/year), most people reach FIRE within 15–17 years starting from zero. Our calculator shows exactly how your monthly contribution affects your FIRE timeline." },
        { question: "What is Lean FIRE vs. Fat FIRE?", answer: "Lean FIRE is early retirement on a frugal budget — typically under $40,000/year, requiring under $1,000,000 invested. Fat FIRE is retiring with $100,000+/year in spending, requiring $2,500,000 or more. Most people target somewhere in between, called Regular FIRE ($50,000–$80,000/year). Your target depends entirely on your lifestyle and what you want from retirement." },
        { question: "What investments should I use to reach FIRE?", answer: "Most FIRE pursuers invest primarily in low-cost index funds — total market funds or S&P 500 funds with expense ratios under 0.10%. Tax-advantaged accounts first: max your 401(k) match, fund a Roth IRA, then return to the 401(k). After that, a taxable brokerage account. Tax-efficiency matters: hold index funds in taxable accounts, bonds in tax-advantaged accounts. The target allocation is typically 80–100% stocks during accumulation." },
      ]} />
            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "Your FIRE number is your annual expenses divided by your safe withdrawal rate. At 4%, this equals Annual Expenses × 25. If you spend $50,000/year, your FIRE number is $1,250,000.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "The 4% rule was designed for 30-year retirements. For early retirees with 40–50 year horizons, many experts recommend 3.5% for extra safety margin.",
                },
              },
              {
                "@type": "Question",
